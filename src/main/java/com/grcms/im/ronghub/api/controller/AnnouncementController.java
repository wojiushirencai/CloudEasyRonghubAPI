...
public class AnnouncementController {
    ...
    public String polciy(HttpServletRequest request, HttpServletResponse response
        ...
        return ContentViewUtil.findNodeView(cmsNodeSerivce, request, "announcement", false);
    }

    @RequestMapping(value = "/announcement/{infoId}.do", method = RequestMethod.GET)
    public String polciyDetail(HttpServletRequest request, HttpServletResponse response, @PathVariable String infoId) throws ECAuthException, ECMemberException, ECCMSNodeException, ECCMSInfoException {
        return ContentViewUtil.findInfoView(cmsNodeSerivce, cmsInfoService, request, "announcement", infoId, false);
    }
}
